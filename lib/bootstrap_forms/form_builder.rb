module BootstrapForms
  class FormBuilder < ActionView::Helpers::FormBuilder
    ...
    %w(collection_select select country_select email_field file_field number_field password_field phone_field radio_button range_field search_field telephone_field text_area text_field url_field).each do |method_name|
